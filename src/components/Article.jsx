                ...
                <div className='blog' >
                    ...
                    <div className='blogread' >
                        <article className='read1' >
                            <a className='blog-header' href="#" style={{ backgroundImage: "url(' https://s3.amazonaws.com/snd-store/a/26553114/02_02_18_508408464_aab_560x292.jpg  ') " }}>
                            ...
                            <div className='blog-content' >
                                <span className='meta' >Published on 18th Feb., 2022</span>
                                <h2 className='cont2' >
                                    <a style={{ color: 'black' }} href="#">Work in Progress</a></h2>
                                <div className='texxt' >
